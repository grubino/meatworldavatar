...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        HabitDao.createTable(db, ifNotExists);
        AccelerationDao.createTable(db, ifNotExists);
        EventDao.createTable(db, ifNotExists);
        RelevanceDao.createTable(db, ifNotExists);
        AvatarDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        HabitDao.dropTable(db, ifExists);
        AccelerationDao.dropTable(db, ifExists);
        EventDao.dropTable(db, ifExists);
        RelevanceDao.dropTable(db, ifExists);
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(AccelerationDao.class);
        registerDaoClass(EventDao.class);
        registerDaoClass(RelevanceDao.class);
