...
public class DaoSession extends AbstractDaoSession {
    ...
    public DaoSession(SQLiteDatabase db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        accelerationDaoConfig = daoConfigMap.get(AccelerationDao.class).clone();
        accelerationDaoConfig.initIdentityScope(type);
        ...
        accelerationDao = new AccelerationDao(accelerationDaoConfig, this);
        ...
        registerDao(Acceleration.class, accelerationDao);
    ...
    public void clear() {
        ...
        accelerationDaoConfig.getIdentityScope().clear();
